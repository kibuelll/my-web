...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20 pb-10">
      ...
      >
        <div className="flex items-center gap-3 bg-white/5 backdrop-blur-xl border border-white/10 px-6 py-2.5 rounded-full hover:bg-secondary/10 hover:border-secondary/20 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
          <a href="https://www.linkedin.com/in/ginanjarsaifulihsan/" target="_blank" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-sm" aria-label="LinkedIn">
          ...
          <a href="https://x.com/kibuellyoi34" target="_blank" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-black hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-sm" aria-label="X (Twitter)">
          ...
          <a href="https://www.instagram.com/kmportant/" target="_blank" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-sm" aria-label="Instagram">
          ...
          <a href="https://gitlab.com/kibuelll" target="_blank" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#2b3137] hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-sm" aria-label="GitHub">
