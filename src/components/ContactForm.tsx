...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      {status === "success" && (
        <m.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-green-400 text-sm flex items-center gap-2 mt-2">
          <CheckCircle2 size={16} /> Pesan berhasil terkirim!
        </m.p>
      )}
      {status === "error" && (
        <m.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-red-400 text-sm flex items-center gap-2 mt-2">
